...
- Monotonic mechanism contracts passed: 20/23
...
- Runtime changes with a wrong or incomplete monotonic direction: mass_rear, feature_point
...
| feature_point | has_point | FAIL | RUNTIME_WRONG_DIRECTION_OR_INCOMPLETE | `bash -> sweep -> slam` | combo/forward_extent |
