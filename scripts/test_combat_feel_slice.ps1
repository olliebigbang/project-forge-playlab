...
& $Godot --headless --verbose --path $PlaylabRoot "res://scenes/combat_feel_slice_0.tscn" -- --mode=combat-feel-slice-0 --live-weapon=giant_wooden_spoon --smoke-seconds=0.2 2>&1 | Tee-Object -FilePath $SceneLog.FullName
